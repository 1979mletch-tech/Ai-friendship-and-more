...
const App = () => {
  ...
  const renderChat = () => (
    <section className="panel">
      ...
      {visibleProjectNotes.length >= entitlements.usageLimits.projectNotesLimit && (
        <p className="warn">Project note limit reached for this plan. Upgrade or delete local notes to add more.</p>
      )}
      <ul>
